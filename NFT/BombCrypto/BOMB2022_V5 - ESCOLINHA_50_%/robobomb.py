        ...
        for (piniref,pendref) in zip(piniref,pendref):
            ...
            while contRepeatMovLoop < qtdRepeatChk:
                    ...
                    if(len(p_list_center) > 0):
                        ...
                        for (p_ini,p_center) in zip(p_list_ini,p_list_center):
                            ...
                            if(onclicked):
                                ...
                                pyautogui.moveTo(x+map_x+listaddX+movPointEndaddX+correc_bug_tela['x'],y+map_y+listaddY+movPointEndaddY+correc_bug_tela['y'],0.2)
                                pyautogui.click()
                                #pyautogui.doubleClick()
                                time.sleep(0.5)
                            else: 
                                pyautogui.moveTo(x+map_x+listaddX+movPointEndaddX+correc_bug_tela['x'],y+map_y+listaddY+movPointEndaddY+correc_bug_tela['y'],0.7)
                ...
                if(movPoint):
                    ...
                    ymovini = int(yi)
                    #####################################################################
                    pyautogui.moveTo(x=xmovini+movPointIniaddX+correc_bug_tela['x'],y=ymovini+movPointIniaddY+correc_bug_tela['y'],duration=0.1)
                    ...
                    xmovend = x
                    ymovend = y
                    pyautogui.moveTo(x=xmovend + movPointEndaddX+correc_bug_tela['x'],y = ymovend + movPointEndaddY+correc_bug_tela['y'], duration=1.5)
