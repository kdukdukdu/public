...
if __name__ == '__main__': 
    ...
    go_conect = cv2.imread('targets/new33/login_assinar_meta/connect.png')#OK
    go_conect2 = cv2.imread('targets/new33/login_assinar_meta/connect2.png')#OK
    go_select_sign_meta1 = cv2.imread('targets/new33/login_assinar_meta/assina1.png')#OK
    go_select_sign_meta2 = cv2.imread('targets/new33/login_assinar_meta/assinar2.png')#OK
    go_select_sign_meta3 = cv2.imread('targets/new33/login_assinar_meta/assinar3.png')#OK

    go_map = cv2.imread('targets/new33/treasure-hunt-icon.png')#OK
    go_back = cv2.imread('targets/new33/voltar.png')#OK
    x_button = cv2.imread('targets/new33/x.png')#OK
    go_hero_work_ini = cv2.imread('targets/new33/heroes.png')#OK

    hero_epic = cv2.imread('targets/new33/heroes/hero_epico.png')#botão voltar pagina
    hero_supr = cv2.imread('targets/new33/heroes/hero_supraro.png')#botão voltar pagina
    hero_raro = cv2.imread('targets/new33/heroes/raro.png')#botão voltar pagina
    hero_commum = cv2.imread('targets/new33/heroes/commun.png')#botão voltar pagina
    #workgreen = cv2.imread('targets/new33/heroes/workgreen.png')#botão voltar pagina
    #noworkred = cv2.imread('targets/new33/heroes/noworkred.png')#botão voltar pagina

    go_work = cv2.imread('targets/new33/heroes/work.png')#OK
    go_home = cv2.imread('targets/new33/heroes/home.png')#OK
    go_upgrade = cv2.imread('targets/new33/heroes/upgrade.png')#OK
    
    go_all_work = cv2.imread('targets/new33/heroes/go_all_work.png')#OK
    go_all_nowork = cv2.imread('targets/new33/heroes/go_all_nowork.png')
    
    go_new_map = cv2.imread('targets/new33/mapa/new-map.png')
    go_select_hero1 = cv2.imread('targets/new33/mapa/select-hero1.png')
    go_select_hero11 = cv2.imread('targets/new33/mapa/select-hero2.png')
    go_hero_work_map = cv2.imread('targets/new33/mapa/heroes.png')
    
    ok_bt = cv2.imread('targets/new33/erro/ok.png')#OK

    #bau_d1 = cv2.imread('targets/new33/mapa/dourado_teste/1.png')#buscar bau d
    #bau_d2 = cv2.imread('targets/new33/mapa/dourado_teste/2.png')#buscar bau d

    #bau_m1 = cv2.imread('targets/new33/mapa/madeira_teste/1.png')#buscar bau d
    #bau_m2 = cv2.imread('targets/new33/mapa/madeira_teste/2.png')#buscar bau d
...
def CheckLogin():
    #checkXBack()
    while findTelaXY(go_conect2) or findTelaXY(go_conect) or findTelaXY(ok_bt) or findTelaXY(go_select_sign_meta1) or findTelaXY(go_select_sign_meta2) or findTelaXY(go_select_sign_meta3): 
        ...
        if (findTelaXY(go_conect) or findTelaXY(go_conect2)):
            ...
            while(findTelaXY(go_conect) or findTelaXY(go_conect2)): #CLICA SO NO PRIMEIRO ENTRAR - SERÁ VERIFICADO UM POR UM
                ...
                sleepTime(20,'INICIANDO O LOGIN NA(S) CONTA  N° '+str(contconta)) #TEMPO CONSIDERÁVEL PARA ATUALIZAR PAGINA
                ...
                findTelaXY(go_select_sign_meta3,True)
                sleepTime(2)
                while(findTelaXY(go_select_sign_meta1)):
...
def reloadContas():
    time.sleep(2)
    #sleepTime(2,'VAMOS REINICIAR TODAS AS CONTAS F5')
    checkXBack()
