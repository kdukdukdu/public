...
if __name__ == '__main__': 
    ...
    go_conect2 = cv2.imread('targets/new50/login_assinar_meta/connect2.png')#Botão para Iniciar o Jogo
    ...
    go_select_sign_meta3 = cv2.imread('targets/new50/login_assinar_meta/assinar3.png')#Botao para Confirmar na Metamask
...
def heroesSelectTpIni(com = False,rare = False,supr = False,epic = False,leg = False,supleg = False):    
    ...
    findBoxImgPoints(go_upgrade,-390,-190,260,195,listFind,120,-1,True,True,20,-6,0,18,4)
